    ...
    training: {
        ...
        subsections: [
            ...
            },
            {
                ...
                description: "The speaker-modulated generator is trained to predict speaker-specific NAMs using the speaker-invariant NAMs generated by the speaker-invariant generator and speaker features.",
                range: [61, 150],
                components: [
                    {
                ...
                note: "Speaker-Invariant Generator training persists from Stage 1."
            }
        ]
    },
    results: {
            ...
            items: [
                {
                    ...
                    specs: [
                        ...
                        { label: "PISA (Speaker-Invariant)", image: "./assets/img/example_1_gen_univ.png" },
                ...
                },
                {
                    ...
                    specs: [
                        ...
                        { label: "PISA (Speaker-Invariant)", image: "./assets/img/example_2_gen_univ.png" },
                ...
                },
                {
                    ...
                    specs: [
                        ...
                        { label: "PISA (Speaker-Invariant)", image: "./assets/img/example_3_gen_univ.png" },
